...
sub load_bootstrap_config {
    ...
    OpenSRF::Transport->message_envelope("OpenSRF::Transport::Redis::MessageWrapper");
...
sub run_service {
    my($class, $service, $pid_dir, $private_service_key) = @_;
    ...
    OpenSRF::Application::private_service_key($private_service_key);
